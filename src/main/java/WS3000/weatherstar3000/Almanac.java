...
public class Almanac extends Thread {
    ...
    String getPrecip(String icaoCode, String key, String month, String day) {
        ...
        try {
            ...
            String precip = JSONResponse.getJSONArray("precipitationAverage").isNull(0) ? "NO REPORT" : String.valueOf(JSONResponse.getJSONArray("precipitationAverage").getFloat(0));
